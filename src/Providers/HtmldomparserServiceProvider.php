...
namespace Sudo\Htmldomparser\Providers;
    ...
    */
    public function publish()
    {
        if ($this->app->runningInConsole()) {
            ...
            // Chạy riêng
            $this->publishes($all, 'sudo/htmldomparser');
            $this->publishes($assets, 'sudo/htmldomparser/assets');
            $this->publishes($config, 'sudo/htmldomparser/config');
            $this->publishes($view, 'sudo/htmldomparser/view');
